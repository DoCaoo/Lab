...
import com.example.lab.adapter.TheLoaiAdapter;
import com.example.lab.dao.TheLoaiDAO;
import com.example.lab.model.TheLoai;

import java.util.ArrayList;
import java.util.List;

public class DsachTheLoai extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dsach_the_loai);

        setTitle("THỂ LOẠI");
        lvTheLoai = (ListView) findViewById(R.id.lvTheLoai);
        registerForContextMenu(lvTheLoai);
        theLoaiDAO = new TheLoaiDAO(DsachTheLoai.this);
        ...
        lvTheLoai.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(DsachTheLoai.this,TheLoaiActivity.class);
                Bundle b = new Bundle();
    ...
    public boolean onContextItemSelected(MenuItem item) {
        switch(item.getItemId()) {
            case R.id.menu_ctx_edit:
                Intent intent1 = new Intent(DsachTheLoai.this,TheLoaiActivity.class);
                startActivity(intent1);
                return(true);
            case R.id.menu_ctx_del:
                Intent intent2 = new Intent(DsachTheLoai.this,TheLoaiActivity.class);
