...
import com.example.lab.adapter.HoaDonAdapter;
...
public class DSachHoaDonActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dsach_hoa_don);

        setTitle("HOÁ ĐƠN");
        lvHoaDon = (ListView)findViewById(R.id.lvHoaDon);
        hoaDonDAO = new HoaDonDAO(DSachHoaDonActivity.this);
        try {
        ...
        lvHoaDon.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(DSachHoaDonActivity.this,DsachHoaDonChiTietActivity.class);
                Bundle b = new Bundle();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            case R.id.add:
                Intent intent = new Intent(DSachHoaDonActivity.this,HoaDonActivity.class);
                startActivity(intent);
                return true;
        }
