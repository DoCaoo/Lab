...
public class ThemSachActivity extends AppCompatActivity {
    ...
    public void getTheLoai(){
        ...
        ArrayAdapter<TheLoai> dataAdapter = new ArrayAdapter<>(this,android.R.layout.simple_spinner_item,listTheLoai);
    ...
    public void addBook(View view){
        sachDAO = new SachDAO(ThemSachActivity.this);
        Sach sach = new Sach(edMaSach.getText().toString(),maTheLoai,edTenSach.getText().toString(),edTacGia.getText().toString(),
    ...
    public void addTheLoai(View view) {
        Intent intent = new Intent(ThemSachActivity.this,TheLoaiActivity.class);
