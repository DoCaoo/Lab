...
import static com.example.lab.DsachNguoiDung.dsNguoiDung;
...
public class HoaDonChiTietDAO {
    ...
    public double getDoanhThuTheoNgay(){
        double doanhThu = 0;
        String sSQL = "SELECT SUM(tongten) from (SELECT SUM(Sach.giaBia * HoaDonChiTiet.soLuong) as 'tongtien' " +
